export const bashCompletions = `# ADHICODE Studio Bash Completion
...
export const psCompletions = `Register-ArgumentCompleter -Native -CommandName "adhicode-studio" -ScriptBlock {
